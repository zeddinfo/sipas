        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-12 mt-6">
                ...
                <div class="card rounded-3">
                    ...
                    mb-3">
                            <div>
                                <h4 class="mb-0">Total Surat Sedang Berlangsung</h4>
                            </div>
                            <div class="icon-shape icon-md bg-light-primary text-primary
                      rounded-1">
                        ...
                        <!-- project number -->
                        <div>
                            <h1 class="fw-bold">{{ $stat['mails_ongoing_count'] }}</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-12 mt-6">
                ...
                <div class="card rounded-3">
                    ...
                    mb-3">
                            <div>
                                <h4 class="mb-0">Total Surat Terarsip</h4>
                            </div>
                            <div class="icon-shape icon-md bg-light-primary text-primary
                      rounded-1">
                        ...
                        <!-- project number -->
                        <div>
                            <h1 class="fw-bold">{{ $stat['mails_archived_count'] }}</h1>
                        </div>
                    </div>
                </div>
            </div>
