                ...
                <div class="card">
                    <div class="tab-content p-4" id="pills-tabContent-basic-forms">
                        <div class="tab-pane tab-example-design fade show active" id="pills-basic-forms-design" role="tabpanel" aria-labelledby="pills-basic-forms-design-tab">
                            <form class="row g-3" method="POST" action="{{ route('user.mail.out.revision.store', ['mail' => $mail->id]) }}">
                                @csrf
                                @method('POST')
                                <div class="col-md-6">
                                ...
                                <div class="form-group col-md-3">
                                    <x-select label="Tipe Surat" name="tipe" value="{{isset($mail) && $mail->attributes ? $mail->attributes[0]->id : ''}}" :options="$tipe">

                                    </x-select>
                                </div>
                                <div class="col-md-3">
                                    <x-select label="Sifat Surat" name="sifat"  value="{{isset($mail) && $mail->attributes ? $mail->attributes[1]->id : ''}}" :options="$sifat">

                                    </x-select>
                                </div>
                                <div class="form-group col-md-3">
                                    <x-select label="Prioritas Surat" name="tipe" value="{{isset($mail) && $mail->attributes ? $mail->attributes[2]->id : ''}}" :options="$prioritas">
                                ...
                                <div class="col-md-6">
                                    <x-input type="date" label="Waktu Surat" value="{{Carbon\Carbon::parse($mail->mail_created_at)->format('Y-m-d')}}" name="date"></x-input>
                                </div>
                                <div class="col-md-6">
