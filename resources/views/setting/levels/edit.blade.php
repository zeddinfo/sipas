                    ...
                    <div class="card">
                        <div class="tab-content p-4" id="pills-tabContent-basic-forms">
                            <div class="tab-pane tab-example-design fade show active" id="pills-basic-forms-design" role="tabpanel" aria-labelledby="pills-basic-forms-design-tab">
                                    <form class="row g-3" method="POST" action="{{ route('admin.setting.level.update', ['level' => $level]) }}">
                                        @csrf
                                        @method('PATCH')
                                        <div class="col-md-6">
                                            <x-input label="Jabatan" value="{{$level->name}}" name="name" placeholder="Jabatan"></x-input>
                                        </div>
                                        <div class="col-md-6">
